import{T as G,d as et,e as g,f as ot}from"./Elements.B8W_hxTW.js";import{i as C,D as q,e as at,a as K,C as Y}from"./FormulaEngine.CYGke5JL.js";const st=a=>class extends a{getCommonStyles(){const t=this.hasAttribute("bold"),e=this.hasAttribute("italic"),o=this.getAttribute("color")||"inherit";return`font-weight: ${t?"bold":"normal"};
    ...
    `},_renderSingleOrRaw(a,t,e,o,s){if(t.type==="raw"){const l=o[t.id]||{},i=l.configurable!==void 0?l.configurable:R(t),r=typeof t.render=="function"?t.render(s):"",n=i?"block":"none";return`<div data-field-wrapper="${t.id}" style="display:${n};">${r}</div>`}return this._renderField(a,t,e,o)},_renderFieldGroups(a,t,e,o,s){return it(t).map(i=>i.type==="single"?this._renderSingleOrRaw(a,i.field,e,o,s):`<div class="row g-2 mb-3">${i.fields.map(n=>{if(n.type==="raw")return typeof n.render=="function"?n.render(s):"";const{configurable:d,innerHTML:c}=this._fieldMarkup(a,n,e,o),u=d?"block":"none";return`<div class="col" data-field-wrapper="${n.id}" style="display:${u};">${c}</div>`}).join("")}</div>`).join("")},bindLiveRules(a,t,e){if(!Array.isArray(e)||e.length===0)return;const o=[document.getElementById(`generic-custom-panel-${t.id}`),document.getElementById(`generic-custom-panel-advanced-${t.id}`),document.getElementById(`generic-custom-panel-ai-${t.id}`)].filter(Boolean);if(o.length===0)return;const s=i=>{for(const r of o){const n=r.querySelector(`[data-field-wrapper="${i}"]`);if(n)return n}return null};e.filter(i=>i.onChange).forEach(i=>{const r=document.getElementById(H(a,i.id));r&&r.addEventListener("change",()=>{const n=rt(a,t,e),d=z(e,n);e.forEach(c=>{const u=s(c.id);if(!u)return;const p=d[c.id]||{},b=p.configurable!==void 0?p.configurable:R(c);u.style.display=b?"block":"none"})})}),e.filter(i=>i.type==="raw"&&typeof i.bind=="function").forEach(i=>i.bind(t,o[0]))},saveCustomSettingsFromModal(a,t,e){!Array.isArray(e)||e.length===0||e.forEach(o=>{if(o.type==="raw"){typeof o.save=="function"&&o.save(t);return}const s=document.getElementById(H(a,o.id));if(!s)return;const l=D(t,o),i=o.type==="boolean"?s.checked:s.value;if(lt(t,o,i),typeof o.onSave=="function"&&o.onSave(t,i),o.mutatesLogicalKey&&i!==l){const r=(o.options||[]).find(n=>n.value===i);r&&r.logicalKey&&(t.setAttribute("data-original-type",r.logicalKey),t.dispatchEvent(new CustomEvent("visual-mutation",{bubbles:!0,detail:{logicalKey:r.logicalKey}})))}})}},nt=new Set(["SETTING-DIVIDER",et.TABLE,"SETTING-CHART","SETTING-SCRIPT"]);function dt(a){return a.getAttribute("data-original-type")||a.tagName.toLowerCase().replace("setting-","")}function N(a){return g[a]||{icon:"🔹",color:"secondary",longLabel:a}}function ct(a){const t=a.hasAttribute("table"),e=t?a.getAttribute("data-table-id"):null,o=[],s=[],l=new Set([a.id]);return document.querySelectorAll("[id]").forEach(i=>{if(i===a||l.has(i.id)||!i.tagName||!i.tagName.startsWith("SETTING-")||nt.has(i.tagName)||typeof i.getAttribute!="function")return;const r=i.hasAttribute("table"),n=i.getAttribute("title")||"(Sin titulo)",d=dt(i);if(!r){s.push({id:i.id,title:n,typeKey:d}),l.add(i.id);return}const c=i.getAttribute("data-table-id");t&&c&&c===e&&(o.push({id:i.id,title:n,typeKey:d}),l.add(i.id))}),document.querySelectorAll(G.table).forEach(i=>{if(typeof i.getData!="function"||t&&i.id===e)return;const r=i.getData(),n=i.getAttribute("title")||"Tabla";(r.columns||[]).forEach(d=>{if(!d.id||l.has(d.id))return;const c=(d.tag||"").replace("setting-","")||"numeric";s.push({id:d.id,title:`[${n}] ${d.title||"(Sin titulo)"}`,typeKey:c}),l.add(d.id)})}),{rowEntries:o,docEntries:s}}function B(a,t){return a.length?`<div class="formula-dict-scroll overflow-auto pe-1" style="max-height: 240px;"><div class="d-flex flex-wrap gap-1">${a.slice().sort((s,l)=>{const i=N(s.typeKey).longLabel||s.typeKey||"",r=N(l.typeKey).longLabel||l.typeKey||"",n=i.localeCompare(r,"es");return n!==0?n:s.title.localeCompare(l.title,"es")}).map(s=>{const l=N(s.typeKey);return`<button type="button" class="btn btn-sm btn-outline-${l.color||"secondary"} formula-dict-item py-0 px-2 mb-1" data-insert-id="${s.id}" title="Clic para insertar @{${s.id}} (${l.longLabel||s.typeKey})"><span class="me-1">${l.icon}</span>${s.title} <code class="ms-1">${s.id}</code></button>`}).join("")}</div></div>`:`<p class="small text-muted fst-italic mb-0">${t}</p>`}function ut(a,t){const e=document.getElementById("designer-canvas");if(!e)return!1;const o=e.getAttribute("data-etl-config");if(!o)return!1;try{const s=new RegExp("\\b"+a+"\\b","g"),l=o.replace(s,t);if(l!==o)return e.setAttribute("data-etl-config",l),!0}catch(s){console.warn("[ETLService] Error al actualizar referencias ETL:",s)}return!1}function pt(a,t){const e=document.getElementById("designer-canvas");if(!e)return!1;const o=e.getAttribute("data-etl-config");if(!o)return!1;try{const s=JSON.parse(o);let l=!1;const i=new RegExp(`\\b${a}\\b`,"g");return s.rules&&Array.isArray(s.rules)&&s.rules.forEach(r=>{r.scriptCode&&i.test(r.scriptCode)&&(r.scriptCode=r.scriptCode.replace(i,t),l=!0)}),l&&e.setAttribute("data-etl-config",JSON.stringify(s)),l}catch(s){return console.warn("[ETLService] No se pudo actualizar el ID en los scripts ETL.",s),!1}}function j(a){let t=document.getElementById("etl-toast-container");t||(t=document.createElement("div"),t.id="etl-toast-container",t.className="toast-container position-fixed bottom-0 end-0 p-3",t.style.zIndex="1100",document.body.appendChild(t));const e=document.createElement("div");e.className="toast align-items-center text-bg-success border-0 show mb-2 shadow-lg",e.innerHTML=`<div class="d-flex"><div class="toast-body small"><i class="fa-solid fa-code-branch me-2"></i>${a}</div></div>`,t.appendChild(e),setTimeout(()=>{e.classList.remove("show"),setTimeout(()=>e.remove(),300)},4e3)}const k=[{id:"hideEdit",attr:"hide-edit",label:"Ocultar en Editor",help:"Solo para calculos de fondo."},{id:"hideView",attr:"hide-view",label:"Ocultar en Visor",help:"No visible al leer el documento."},{id:"hidePrint",attr:"hide-print",label:"Ocultar al Imprimir",help:"Se omitira en la exportacion a PDF."},{id:"hideWhatsapp",attr:"hide-whatsapp",label:"Ocultar en WhatsApp",help:"Se excluira del mensaje de texto enviado."},{id:"readonly",attr:"readonly",label:"Solo Lectura (bloqueado en el Editor)",help:"Se ve con su valor actual, pero no se puede editar al llenar el documento."}],F=[{id:"spanEV",inputId:"modal-span-ev",attr:"span-edit-viewer",label:"Ancho Pantalla (Grid 1-12)"},{id:"spanP",inputId:"modal-span-p",attr:"span-print",label:"Ancho Impresion (Grid 1-12)"}],mt=a=>class extends a{_renderVisibilityTogglesHTML(t,e){const o=Object.fromEntries(k.map(d=>[d.id,d])),s=t.filter(d=>d!=="readonly"&&o[d]).map(d=>o[d]),l=t.includes("readonly"),i=C(e.formula),r=(d,c,u)=>{const p=u||e[d.id];return`
      ...
      `}bindSettingsEvents(){const t=this.querySelector(".btn-open-settings");t&&(t.onclick=e=>{e.preventDefault(),e.stopPropagation(),this._openSettingsModal()})}_openSettingsModal(){var U;const t=this.tagName.toLowerCase().split("-")[1],e=this.hasAttribute("table"),o=((U=g[t])==null?void 0:U.settings)||{width:!0,visibility:!0},s={spanEV:this.getAttribute("span-edit-viewer")||this.spanEV||12,spanP:this.getAttribute("span-print")||this.spanP||12,hidePrint:this.hasAttribute("hide-print"),hideWhatsapp:this.hasAttribute("hide-whatsapp"),hideEdit:this.hasAttribute("hide-edit"),hideView:this.hasAttribute("hide-view"),align:this.getAttribute("alignment")||"left",total:this.hasAttribute("total"),totalPosition:this.getAttribute("total-position")||"tfoot",readonly:this.hasAttribute("readonly"),formula:this.getAttribute("formula")||""};let l="",i="",r="";if(Array.isArray(o.custom)){const f=V.renderCustomSettingsHTML(t,this,o.custom,o.advancedCustom||[],{title:o.customTitle,icon:o.customIcon,hideTitle:o.customHideTitle},o.aiCustom||[],{title:o.aiCustomTitle,icon:o.aiCustomIcon,hideTitle:o.aiCustomHideTitle});l=f.basicHTML,i=f.advancedHTML,r=f.aiHTML}else o.custom&&typeof this.getCustomSettingsHTML=="function"&&(l=this.getCustomSettingsHTML());const n=o.visibility===!0?k.map(f=>f.id):Array.isArray(o.visibility)?o.visibility:[],d=n.length>0,c=d?this._renderVisibilityTogglesHTML(n,s):"",u=ot(this.tagName);let p="";e&&u&&(p=`
          ...
          `),l+=p;const b=typeof o.formula=="function"?o.formula(this):!!o.formula;let h="",m={rowEntries:[],docEntries:[]};if(b){const f=tt=>`formula-sub-${tt}-${this.id}`;m=ct(this);const X=m.rowEntries.length?`
              <div class="mb-3">
          ...
          `}let v="";const x=o.width===!0?F.map(f=>f.id):Array.isArray(o.width)?o.width:[],w=e?[]:x,$=w.length>0;($||o.style||e)&&(v=`
            ...
            <div class="row g-4 bg-white p-3 border rounded shadow-sm">
                ...
                `:""}
            </div>`);const L=`tab-custom-${this.id}`,S=`tab-ai-${this.id}`,M=`tab-advanced-${this.id}`,T=`tab-formula-${this.id}`,I=`tab-vis-${this.id}`,P=`tab-design-${this.id}`;let A="",E="",y=!0;o.custom&&l&&(A+=`
            <li class="nav-item" role="presentation">
        ...
        </div>`;document.body.insertAdjacentHTML("beforeend",i);const r=document.getElementById("advanced-settings-modal"),n=new bootstrap.Modal(r);n.show(),o&&o(),document.getElementById("btn-save-settings").onclick=()=>{this._saveSettingsFromModal()&&n.hide()}}_saveSettingsFromModal(){var d,c,u,p,b,h;const t=m=>{var v;return(v=document.getElementById(m))==null?void 0:v.value},e=m=>{var v;return(v=document.getElementById(m))==null?void 0:v.checked},o=t("modal-field-id");if(o!==void 0){const m=o.trim().replace(/[^a-zA-Z0-9_]/g,"");if(m==="")return q.toast("⛔ El ID no puede estar vacio ni contener solo caracteres especiales.","danger"),!1;if(m!==this.id){let v;const x=this.closest(G.table);if(x?v=x.querySelector(`[field-id="${m}"]`)||x.querySelector(`#${m}`):v=document.getElementById(m)||document.querySelector(`[field-id="${m}"]`),v&&v!==this){q.toast(`⚠️ El ID "${m}" ya esta siendo utilizado por otro campo.`,"warning");const $=document.getElementById("modal-field-id");return $.classList.add("is-invalid","border-danger"),$.focus(),!1}const w=this.id;this.id=m,this.setAttribute("id",m),this.setAttribute("field-id",m),this._updateETLScripts(w,m)}}this.setInternalUpdate(!0);const s=this.tagName.toLowerCase().split("-")[1],l=(c=(d=g[s])==null?void 0:d.settings)==null?void 0:c.custom,i=(p=(u=g[s])==null?void 0:u.settings)==null?void 0:p.advancedCustom,r=(h=(b=g[s])==null?void 0:b.settings)==null?void 0:h.aiCustom;Array.isArray(l)?V.saveCustomSettingsFromModal(s,this,[...l,...i||[],...r||[]]):typeof this.saveCustomSettings=="function"&&this.saveCustomSettings(),k.forEach(m=>{const v=`modal-${m.attr}`;document.getElementById(v)&&(e(v)?this.setAttribute(m.attr,""):this.removeAttribute(m.attr))}),F.forEach(m=>{document.getElementById(m.inputId)&&this.setAttribute(m.attr,t(m.inputId))}),document.getElementById("modal-align")&&this.setAttribute("alignment",t("modal-align"));const n=document.getElementById("modal-total");return n&&(n.checked?this.setAttribute("total",""):this.removeAttribute("total")),document.getElementById("modal-total-position")&&this.setAttribute("total-position",t("modal-total-position")),document.getElementById("modal-formula")&&this.setAttribute("formula",t("modal-formula")||""),document.getElementById("modal-readonly")&&C(this.getAttribute("formula"))&&this.setAttribute("readonly",""),this.setInternalUpdate(!1),this.render(),!0}_updateETLScripts(t,e){pt(t,e)&&j(`Scripts ETL actualizados: <b>${t}</b> ➔ <b>${e}</b>`)}_showToast(t){j(t)}};function bt(a,t){return t&&t!==document&&(t.querySelector(`[field-id="${a}"]`)||t.querySelector(`#${a}`))||document.querySelector(`[field-id="${a}"]`)||document.getElementById(a)||null}function ht(a){return a?typeof a.getData=="function"?a.getData().value??"":a.getAttribute("edit-value")||"":""}function J(a,t,e){if(e.has(a))throw new Y([...e,a]);const o=bt(a,t);if(!o)return"";const s=o.getAttribute&&o.getAttribute("formula");if(s&&C(s)){e.add(a);try{return K(s,l=>J(l,t,e))}finally{e.delete(a)}}return ht(o)}function W(a,t){const e=a.querySelector("input, textarea");e&&(e.classList.toggle("is-invalid",!!t),e.title=t||"")}function O(a){const t=a.getAttribute("formula");if(!t||!C(t))return;const e=a.closest('[id^="form-container-"]')||a.closest("tr")||a.parentElement;try{const o=new Set([a.id]),s=K(t,l=>J(l,e,o));a.removeAttribute("formula-error"),a.setCalculatedValue(s),W(a,"")}catch(o){const s=o&&o.message||"Error en la fórmula.";console.error(`[Fórmula] "${a.id}":`,s),a.setAttribute("formula-error",s),a.setCalculatedValue(o instanceof Y?"#CIRCULAR":"#ERROR"),W(a,s)}}function ft(a){if(a._formulaReactivityBound)return;a._formulaReactivityBound=!0;const t=a.closest('[id^="form-container-"]')||a.closest(".tab-content")||a.closest("#document-canvas")||a.closest("#designer-canvas")||document.body,e=o=>{o&&o.type==="script-update"||(a._formulaTimeout&&clearTimeout(a._formulaTimeout),a._formulaTimeout=setTimeout(()=>O(a),250))};t.addEventListener("change",e,!0),t.addEventListener("input",e,!0),t.addEventListener("table-change",e,!0)}const _={evaluateFormulaField(a){O(a)},renderEditor(a,t){const e=a.getAttribute("title")||t.defaultTitle||"Campo";let o=a.getAttribute("edit-value");!o&&t.defaultValue!==void 0&&(o=typeof t.defaultValue=="function"?t.defaultValue(a):t.defaultValue,a.setAttribute("edit-value",o));const s=a.getCommonStyles(),l=C(a.getAttribute("formula"));l&&!a.hasAttribute("readonly")&&(a._isInternalUpdate=!0,a.setAttribute("readonly",""),a._isInternalUpdate=!1);let i;if(t.renderEditorContent)i=t.renderEditorContent(a,o,s);else{const r=(typeof t.inputType=="function"?t.inputType(a):t.inputType)||"text",n=t.icon||"fa-font",d=a.getAttribute("placeholder-text")||t.placeholder,c=d?` placeholder="${d}"`:"",u=a.getAttribute("max-length"),p=u?` maxlength="${u}"`:"",b=a.hasAttribute("readonly"),h=b?" readonly":"",m=b?" bg-light":"",v=t.renderEditorInput?t.renderEditorInput(a,s,o):`<input autocomplete="off" spellcheck="false" type="${r}" class="form-control form-control-sm shadow-none border-1${m}"
    ...
    `}if(a.innerHTML=a.renderViewerStructure(i),t.bindEditorEvents)t.bindEditorEvents(a);else{const r=a.querySelector(`#input-${a.id}`);a._attachStyleEventListeners(r)}l&&(ft(a),setTimeout(()=>O(a),50))},renderViewer(a,t){const e=a.getAttribute("edit-value"),o=a.getCommonStyles();if(t.renderViewerContent){const i=t.renderViewerContent(a,e,o);if(i===null){a.innerHTML="";return}a.innerHTML=a.renderViewerStructure(i);return}const s=e?t.formatDisplay?t.formatDisplay(e,a):e:"---",l=`<div class="py-1" style="${o}">${s}</div>`;a.innerHTML=a.renderViewerStructure(l)},renderPrinter(a,t){const e=a.getAttribute("edit-value"),o=a.getAttribute("type")||"Visual",s=a.getCommonStyles();if(t.renderPrinterContent){const r=t.renderPrinterContent(a,e,s);if(r===null){a.innerHTML="";return}a.innerHTML=a.renderPrinterStructure(r,o);return}const l=e?t.formatDisplay?t.formatDisplay(e,a):e:"---",i=`
        <div style="${s} font-size: inherit; padding: 2px 0;">
            ${l}
        </div>
    `;a.innerHTML=a.renderPrinterStructure(i,o)},getWhatsapp(a,t){if(t.getWhatsappContent)return t.getWhatsappContent(a);const e=a.getAttribute("title"),o=a.getAttribute("edit-value")||"";let s=o;return o&&(t.formatWhatsapp?s=t.formatWhatsapp(o,a):t.formatDisplay&&(s=t.formatDisplay(o,a))),`*${e}:* ${s}`}};function gt(a){if(!a.id){const t=a.tagName.toLowerCase().split("-")[0],e=Math.random().toString(36).substr(2,9);a.id=`${t}_${e}`}}function vt(a,t){const e=(t||"").trim();if(!e)return;const o=a.tagName.toLowerCase().split("-")[1]||"field",l=e.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9\s]/g,"").trim().split(/\s+/).filter(Boolean);if(!l.length)return;const i=20;for(;l.join("").length>i;){let p=-1,b=-1;for(let h=0;h<l.length;h++)l[h].length>p&&(p=l[h].length,b=h);if(b!==-1)l[b]=l[b].slice(0,-1);else break}const r=l.join(""),n=`${o}_${r}`;let d=n,c=2;for(;document.getElementById(d)&&document.getElementById(d)!==a;)d=`${n}${c}`,c++;const u=a.id;u!==d&&(a.id=d,Z(u,d),Q(a,u,d))}function yt(a){const t=document.getElementById("designer-canvas");return(t==null?void 0:t.getAttribute("data-template-has-docs"))==="true"}function Q(a,t,e){const o=document.getElementById("designer-canvas");if(!o)return;const s=`@{${t}}`,l=`@{${e}}`;o.querySelectorAll("[formula]").forEach(i=>{const r=i.getAttribute("formula");r&&r.includes(s)&&i.setAttribute("formula",r.split(s).join(l))})}function Z(a,t){ut(a,t)}function wt(a){if(!a||a==="#")return{isVideo:!1};const t=["mp4","webm","ogg","mov"],e=a.split("?")[0].toLowerCase();if(t.some(i=>e.endsWith("."+i)))return{isVideo:!0,type:"file"};const s=/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/,l=a.match(s);return l&&l[2].length===11?{isVideo:!0,type:"youtube",id:l[2]}:{isVideo:!1}}function xt(a,t){let e=document.getElementById("global-audio-player");if(!e){if(e=document.createElement("div"),e.id="global-audio-player",e.style.cssText=`
  ...
  `;document.body.insertAdjacentHTML("beforeend",l);const i=document.getElementById("media-preview-modal");new bootstrap.Modal(i).show(),i.addEventListener("hidden.bs.modal",()=>i.remove())}function Et(a,t){const e=document.getElementById("media-preview-modal");e&&e.remove();const o=`
    <div class="modal fade" id="media-preview-modal" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg bg-transparent">
          <div class="modal-body p-0 position-relative text-center">
  ...
  `;document.body.insertAdjacentHTML("beforeend",o);const s=document.getElementById("media-preview-modal");new bootstrap.Modal(s).show(),s.addEventListener("hidden.bs.modal",()=>s.remove())}async function Ct(a,t){try{await navigator.clipboard.writeText(t),Tt(a)}catch(e){console.warn("[ClipboardService] Error al copiar al portapapeles:",e)}}function Tt(a){const t=document.createElement("div");t.textContent="¡Copiado!",t.style.cssText=`
