...
`}}},V={hideInToolbox:!0,columnFacade:"input",icon:"📧",shortLabel:"Correo",longLabel:"Correo Electrónico",spanEV:4,spanP:4,color:"secondary",settings:{width:!0,visibility:!0,style:!0},aiPrompt:"I/O: String. Espera una dirección de correo válida.",aiPromptLong:`I/O: String. doc.getValue() retorna una dirección de correo. doc.setValue() espera un string con formato de correo válido (ej: "usuario@dominio.com").
    ...
    Tips para el AI:
      ...
      • Si necesitas leer el valor en un script (para autenticación, API, etc.), hazlo internamente en el script sin mostrarlo.`,field:{kind:"password",icon:"fa-key",renderEditorContent:(e,t,a)=>{const o=e.getAttribute("title")||"Contraseña",r=e.hasAttribute("readonly"),i=e.getAttribute("placeholder-text")||"Ingrese contraseña...",s=e.getAttribute("max-length"),l=s?` maxlength="${s}"`:"";return`
        ...
        <div class="card-body p-3">
          ...
          <div class="input-group input-group-sm shadow-none">
            <input autocomplete="off" spellcheck="false" type="password" class="form-control border-1 shadow-none${r?" bg-light":""}"
                   id="input-${e.id}" value="${t||""}" placeholder="${i}"${l}${r?" readonly":""}>
    ...
    Tips para el AI:
      ...
      • Para campos calculados (fórmulas), marca is-calculated y asigna el valor por script.`,field:{kind:"number",icon:"fa-hashtag",defaultTitle:"Número",formatDisplay:(e,t)=>d.formatNumericValue(e,{decimals:t.getAttribute("decimals")||"",separators:t.getAttribute("separators")||"auto",unit:t.getAttribute("unit")||""})??"---",renderEditorContent:(e,t,a)=>{const o=e.getAttribute("title")||"Número",r=e.hasAttribute("is-calculated"),i=e.hasAttribute("readonly"),s=r||i,{attrs:l,spinnerClass:n}=d.numericInputAttrs(e),c=s?"readonly":"",u=r?"Calculado...":"0.00",p=e.getAttribute("unit")||"",y=`<input autocomplete="off" spellcheck="false" type="number" class="${p?`form-control shadow-none ${n} ${s?"bg-light text-muted":""}`:`form-control form-control-sm shadow-none ${n} ${s?"bg-light text-muted":""}`}"
                 id="input-${e.id}" value="${t||""}" style="${a}"
                 placeholder="${u}"
                 ${c}${l}>`,T=p?`<div class="input-group input-group-sm">
            ${y}
    ...
    Tips para el AI:
      ...
      • Para porcentajes → usa percentage.`,field:{kind:"currency",icon:"fa-money-bill-wave",defaultTitle:"Importe",renderEditorContent:(e,t,a)=>{const o=e.getAttribute("title")||"Importe",r=e.getAttribute("currency")||"$",i=e.hasAttribute("is-calculated"),s=e.hasAttribute("readonly"),l=i||s,{attrs:n,spinnerClass:c}=d.numericInputAttrs(e),u=`form-control shadow-none border-1 ${c} ${l?"bg-light text-muted":""}`,p=l?"readonly":"";return`
      <div class="card border-0 shadow-sm border-start border-4 border-${e.uiColor} h-100">
        <div class="card-body p-3">
          <div class="d-flex justify-content-between align-items-center mb-2">
            <div class="d-flex align-items-center">
              <label class="form-label fw-bold text-body small mb-0 me-1">
                ...
                ${i?'<span class="badge bg-secondary ms-2" style="font-size:0.6rem">AUTO</span>':s?'<i class="fa-solid fa-lock ms-2 text-muted" style="font-size:0.7rem" title="Solo lectura"></i>':""}
              </label>
            </div>
            ${e.renderStyleControls()}
          </div>
    ...
    Tips para el AI:
      ...
      • Para multiplicar un monto por un porcentaje: precio * (descuento / 100).`,field:{kind:"percentage",icon:"fa-percent",defaultTitle:"Porcentaje",renderEditorContent:(e,t,a)=>{const o=e.getAttribute("title")||"Porcentaje",r=e.hasAttribute("is-calculated"),i=e.hasAttribute("readonly"),s=r||i,{attrs:l,spinnerClass:n}=d.numericInputAttrs(e);return`
      <div class="card border-0 shadow-sm border-start border-4 border-${e.uiColor} h-100">
        <div class="card-body p-3">
          <div class="d-flex justify-content-between align-items-center mb-2">
            <div class="d-flex align-items-center">
          ...
          <div class="input-group input-group-sm">
            <input autocomplete="off" spellcheck="false" type="number" class="form-control shadow-none ${n} ${s?"bg-light text-muted":""}"
                   id="input-${e.id}" value="${t||""}" style="${a}"
                   placeholder="0.00"
                   ${s?"readonly":""}${l}>
    ...
    Tips para el AI:
      ...
      • Para fecha y hora juntas, usa el facade datetime.`,field:{kind:"date",icon:"fa-calendar-days",inputType:"date",defaultValue:()=>new Date().toISOString().split("T")[0],formatDisplay:(e,t)=>d.formatDateWithMask(e,t==null?void 0:t.getAttribute("display-mask")),formatWhatsapp:(e,t)=>{const a=t==null?void 0:t.getAttribute("display-mask");return a&&a!=="default"?d.formatDateWithMask(e,a):new Date(e).toLocaleDateString()},renderEditorInput:(e,t,a)=>{const o=e.hasAttribute("readonly"),r=e.getAttribute("min-date"),i=e.getAttribute("max-date");let s="";return r&&(s+=` min="${r}"`),i&&(s+=` max="${i}"`),`<input autocomplete="off" spellcheck="false" type="date" class="form-control form-control-sm shadow-none border-1${o?" bg-light":""}"
                 id="input-${e.id}" value="${a||""}" style="${t}"${o?" readonly":""}${s}>`}}},k={hideInToolbox:!0,columnFacade:"datetime",icon:"🕒",shortLabel:"Hora",longLabel:"Hora",spanEV:4,spanP:4,color:"info",settings:{width:!0,visibility:!0,style:!0},aiPrompt:"I/O: String. Formato esperado de 24 horas: 'HH:mm' (ej: '14:30').",aiPromptLong:`I/O: String. doc.getValue() retorna 'HH:mm' en formato 24h (ej: '14:30'). doc.setValue() espera una cadena en formato 'HH:mm'.
    ...
    Tips para el AI:
      ...
      • is-automatic es útil para timestamps de registro.`,field:{kind:"time",defaultTitle:"Hora",renderEditorContent:(e,t,a)=>{const o=e.getAttribute("title")||"Hora",r=t||"",i=e.hasAttribute("is-automatic"),s=e.hasAttribute("compact"),l=i||e.hasAttribute("readonly"),n=e.getAttribute("min-time"),c=e.getAttribute("max-time");let u="";n&&(u+=` min="${n}"`),c&&(u+=` max="${c}"`);const p=`
      <input type="time" class="form-control ${s?"form-control-sm border-0 bg-transparent px-1":"form-control-sm shadow-none border-1"} fw-bold${l?" bg-light":""}"
             id="input-${e.id}" value="${r}" style="${a}" ${l?"readonly":""}${u}>
    `;return s?p:`
        <div class="card border-0 shadow-sm border-start border-4 border-${e.uiColor} h-100">
          <div class="card-body p-3">
            <div class="d-flex justify-content-between align-items-center mb-2">
...
Soporte = dept_002`,default:"",help:'<i class="fa-solid fa-info-circle me-1"></i> Una opción por línea, con el formato "Etiqueta = Valor". La persona ve la etiqueta; el documento guarda el valor.'}],width:!0,visibility:!0,style:!0},aiPrompt:'I/O: String. Retorna y espera la opción seleccionada exactamente como fue definida en la lista de opciones configurada (ver diccionario de variables). En modo "Pares", el valor de I/O es el valor interno configurado, no la etiqueta visible. NUNCA inventes ni envíes un valor que no esté en esa lista.',aiPromptLong:`I/O: String. doc.getValue() retorna la opción seleccionada. doc.setValue() espera un valor exacto de la lista configurada.
    ...
    Tips para el AI:
      ...
      • Para Sí/No, usa boolean en vez de select con dos opciones.`,field:{kind:"select",icon:"fa-caret-down",defaultTitle:"Seleccione...",renderEditorInput:(e,t,a)=>{const o=a||"",i=e.getAttribute("data-source-mode")==="paired"?d.parsePairedOptions(e.getAttribute("paired-options")||""):(e.getAttribute("options")||"").split(",").map(l=>l.trim()).filter(l=>l!=="").map(l=>({label:l,value:l})),s=e.hasAttribute("readonly");return`
          <select class="form-select form-select-sm shadow-none${s?" bg-light":""}" id="input-${e.id}" style="${t}" ${s?"disabled":""}>
            <option value="" ${o===""?"selected":""}>Seleccione una opción...</option>
            ${i.map(l=>`<option value="${l.value}" ${o===l.value?"selected":""}>${l.label}</option>`).join("")}
          </select>
    ...
    Tips para el AI:
      ...
      • En scripts condicionales: if (doc.getValue('aprobado')) { ... } funciona directamente.`,field:{kind:"boolean",icon:"fa-toggle-on",defaultTitle:"Seleccionar",defaultValue:e=>e!=null&&e.hasAttribute("default-state")?"true":"false",renderEditorContent:(e,t)=>{const a=e.getAttribute("title")||"Seleccionar",o=t==="true",r=e.hasAttribute("readonly"),i=e.getAttribute("display-mode")||"switch",s=e.getAttribute("theme-color")||"success",l=e.hasAttribute("true-text")||e.hasAttribute("false-text"),n=e.getAttribute("true-text")||"Sí",c=e.getAttribute("false-text")||"No";let u;if(i==="checkbox")u=`
          ...
          <button type="button" class="btn btn-${o?s:"secondary"} btn-sm fw-bold" id="check-${e.id}"
                  data-checked="${o}" ${r?"disabled":""}>${p}</button>`}else{const p=`
          <div class="form-check form-switch mb-0">
            <input autocomplete="off" spellcheck="false" class="form-check-input" type="checkbox" id="check-${e.id}"
                   ${o?"checked":""} ${r?"disabled":""} style="cursor:${r?"not-allowed":"pointer"}">
          </div>`;u=l?`<div class="d-flex align-items-center gap-2">${p}<span class="small fw-bold text-${o?s:"muted"}">${o?n:c}</span></div>`:p}return`
      <div class="card border-0 shadow-sm border-start border-4 border-${e.uiColor} h-100">
...
const resp = await api.execute({
  ...
  body: { monto: 50 },     // se combina con el Cuerpo Base (POST/PUT)
    ...
    Tips para el AI:
      ...
      • Para leer datos de la API en un script: const resp = await doc.api('mi_api').execute({id: doc.getValue('cliente_id')});`},f={input:A,divider:w,numeric:S,datetime:E,media:C,string:P,text:$,email:V,password:I,number:N,currency:O,percentage:L,date:M,time:k,section:D,subsection:R,image:j,audio:q,video:_,select:z,boolean:U,url:H,table:F,chart:Y,html:J,script:B,api:K};function b(e){let t="";return typeof e=="string"?t=e:e&&typeof e=="object"&&(t=e.tag||e.tagName||""),(t||"").toLowerCase().split("-")[1]||""}function ae(e,t){return f[b(e)]||t}function v(e){var a;const t=b(e);return((a=f[t])==null?void 0:a.columnFacade)||t}function oe(e){return v(e)==="numeric"}const h=Object.freeze(Object.fromEntries(Object.keys(f).map(e=>[e,`setting-${e}`]))),re=Object.freeze(Object.fromEntries(Object.keys(f).map(e=>[e,`SETTING-${e.toUpperCase()}`]))),G=()=>{const e={},t=new Set;for(const a of Object.values(f))a.columnFacade&&t.add(a.columnFacade);for(const[a,o]of Object.entries(f)){const r=h[a];if(o.columnFacade){const i=o.columnFacade;e[i]||(e[i]=[]),e[i].push(r)}else t.has(a)||(e[a]||(e[a]=[]),e[a].push(r))}return e},m=G(),ie=Object.freeze(m.numeric||[]);Object.freeze(m.input||[]);const W=Object.freeze(m.divider||[]);Object.freeze(m.datetime||[]);Object.freeze(m.media||[]);const Q=Object.freeze(m.table||[]),X=Object.freeze(m.script||[]),Z=Object.freeze(m.api||[]);Object.freeze(m.url||[]);Object.freeze(m.boolean||[]);Object.freeze(m.select||[]);Object.freeze(m.chart||[]);Object.freeze(m.html||[]);const g=e=>{const t=new Set(e);return new Proxy(t,{get(a,o){if(o==="add"||o==="delete"||o==="clear")return()=>{throw new TypeError("Cannot mutate a frozen Set")};const r=a[o];return typeof r=="function"?r.bind(a):r},set(){throw new TypeError("Cannot set properties on a frozen Set")},deleteProperty(){throw new TypeError("Cannot delete properties on a frozen Set")}})};g(Q);g(W);g(X);g(Z);function se(e){return b(e)==="table"}function le(e){return b(e)==="script"}function ne(e){return b(e)==="api"}function ce(e){return v(e)==="divider"}function de(e){return b(e)==="section"}function ue(e){return b(e)==="subsection"}function pe(e){return b(e)==="url"}function me(e){return b(e)==="boolean"}const ee=()=>{var t;const e=[];for(const[a,o]of Object.entries(f)){const r=(t=o.settings)==null?void 0:t.formula;(r===!0||typeof r=="function")&&e.push(h[a])}return e.join(", ")},be=ee();export{te as C,be as F,ie as N,h as T,d as U,ne as a,ce as b,de as c,ue as d,f as e,se as f,re as g,oe as h,le as i,b as j,ae as k,me as l,pe as m};
