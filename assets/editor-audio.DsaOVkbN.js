import{B as h}from"./BaseElement.D4tveIlI.js";import"./Elements.BsmmG6jM.js";import"./FormulaEngine.CYGke5JL.js";class f extends h{render(){const a=this.getAttribute("title")||"Audio";let e={url:"",title:"",caption:""};try{const d=this.getAttribute("edit-value");d&&(e=JSON.parse(d))}catch{e.url=this.getAttribute("edit-value")||""}const c=this.hasAttribute("readonly"),s=c?" readonly":"",n=c?" disabled":"",i=`
      <div class="mb-3">
