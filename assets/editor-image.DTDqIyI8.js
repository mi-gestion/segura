import{B as c}from"./BaseElement.MCYYqpju.js";import"./Elements.BsmmG6jM.js";import"./FormulaEngine.CYGke5JL.js";class u extends c{static get observedAttributes(){return[...super.observedAttributes,"object-fit","alt-text"]}render(){const t=this.getAttribute("title")||"Imagen";let s={url:"",title:"",caption:""};try{const e=this.getAttribute("edit-value");e&&(s=JSON.parse(e))}catch{s.url=this.getAttribute("edit-value")||""}const l=this.hasAttribute("readonly"),i=l?" readonly":"",a=l?" disabled":"",n=`
      <div class="mb-3">
