import{B as k,G as D}from"./BaseElement.D4tveIlI.js";import{D as M}from"./main.BDcaNCsR.js";import{T as I}from"./TableUtils.CNB0qtxv.js";import{T as x,l as N,m as _,N as L,i as F}from"./Elements.BsmmG6jM.js";import{D as S,i as q,a as B,C as j}from"./FormulaEngine.CYGke5JL.js";import"./preload-helper.B26yNZZz.js";const T={exportCSV(m,t,e=","){let a=[];t.forEach(r=>{_(r)?(a.push(`"${r.title} (Texto)"`),a.push(`"${r.title} (URL)"`)):a.push(`"${r.title}"`)});const i=m.map(r=>t.map(s=>{const l=r.find(o=>o.fieldId===s.id);let n=l?l.value:"";if(_(s)){let o="",h="";try{const d=typeof n=="string"&&n.startsWith("{")?JSON.parse(n):n;o=d.text||"",h=d.url||""}catch{}return`"${String(o).replace(/"/g,'""')}","${String(h).replace(/"/g,'""')}"`}return n=String(n).replace(/"/g,'""'),`"${n}"`}).join(e));return a.join(e)+`
`+i.join(`
