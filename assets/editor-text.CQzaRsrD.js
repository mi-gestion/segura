import{B as a}from"./BaseElement.BA7nnqi4.js";import"./Elements.B8W_hxTW.js";import"./FormulaEngine.CYGke5JL.js";class d extends a{constructor(){super(),this.quill=null,this._quillTimeout=null}render(){const e=this.getAttribute("title")||"Campo";let t=this.getAttribute("edit-value")||"";const i=this.getAttribute("rich-text")!=="false",o=this.getCommonStyles(),s=this.hasAttribute("readonly");if(!i){const l=`
