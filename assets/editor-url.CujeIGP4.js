import{B as y}from"./BaseElement.B8W23fke.js";import{a as w,S as x}from"./main.DUP_xBVN.js";import"./Elements.BsmmG6jM.js";import"./FormulaEngine.CYGke5JL.js";import"./preload-helper.B26yNZZz.js";class E extends y{static get observedAttributes(){return[...super.observedAttributes,"options"]}setData(e){super.setData(e),e.options&&this.setAttribute("options",e.options)}_hasValue(){const e=this.getAttribute("edit-value");if(!e)return!1;try{return JSON.parse(e).url!==""}catch{return!1}}render(){const e=this.getAttribute("title")||"Enlace",s=this.getAttribute("edit-value"),n=this.hasAttribute("readonly"),c=n?" readonly":"",r=n?" disabled":"";let l={url:"",text:""};try{s&&(l=JSON.parse(s))}catch{}let a={showTextUrl:!0,showQR:!0};try{const o=this.getAttribute("options");o&&(a={...a,...JSON.parse(o)})}catch{}let i=l.url||"";i&&!i.startsWith("http")&&!i.startsWith("github://")&&(i="https://"+i);const b=i.startsWith("github://"),d=this._checkExtension(i,["mp3","wav","ogg","m4a"]),f=this._checkExtension(i,["jpg","jpeg","png","gif","webp","svg"])||i.includes("quickchart.io/chart"),m=this._checkVideo(i),h=this._checkInternalDoc(i),g=l.text||(a.showTextUrl?l.url:"Enlace"),v=b?`<a href="#" class="text-warning text-decoration-underline fw-bold text-truncate btn-test-github" style="font-size: 0.85rem;"><i class="fa-solid fa-lock me-1 small"></i>${g} (Descargar)</a>`:`<a href="${i}" target="_blank" rel="noopener noreferrer" class="text-primary text-decoration-underline fw-bold text-truncate" style="font-size: 0.85rem;"><i class="fa-solid fa-arrow-up-right-from-square me-1 small"></i>${g}</a>`,t=`
      <div class="mb-3">
          ...
          <div class="card-body p-3">
            ...
            ${l.url?`<div class="bg-white border rounded p-2 mt-2 shadow-sm">
                       <div class="d-flex align-items-center gap-2">
                           ${this._renderActionButton(d,f,m,h)}
