import{B as u}from"./BaseElement.d_VolxdG.js";import"./Elements.B8W_hxTW.js";import"./FormulaEngine.CYGke5JL.js";class b extends u{static get observedAttributes(){return[...super.observedAttributes,"controls","autoplay"]}render(){const a=this.getAttribute("title")||"Video";let s={url:"",title:"",caption:""};try{const i=this.getAttribute("edit-value");i&&(s=JSON.parse(i))}catch{s.url=this.getAttribute("edit-value")||""}const e=this.hasAttribute("readonly"),l=e?" readonly":"",r=e?" disabled":"",t=`
      <div class="mb-3">
