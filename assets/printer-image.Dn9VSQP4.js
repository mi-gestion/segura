import{B as n}from"./BaseElement.9fGzvbuo.js";import"./Elements.B8W_hxTW.js";import"./FormulaEngine.CYGke5JL.js";class l extends n{static get observedAttributes(){return[...super.observedAttributes,"object-fit","alt-text"]}render(){let t={url:"",title:"",caption:""};try{const e=this.getAttribute("edit-value");e&&(t=JSON.parse(e))}catch{t.url=this.getAttribute("edit-value")||""}if(!t.url){this.innerHTML="";return}const i=t.url.startsWith("github://"),s=this.getAttribute("object-fit")||"contain",o=(this.getAttribute("alt-text")||t.title||"").replace(/"/g,"&quot;");this.innerHTML=`
