import{B as T}from"./BaseElement.MCYYqpju.js";import{T as p}from"./TableUtils.CNB0qtxv.js";import"./Elements.BsmmG6jM.js";import"./FormulaEngine.CYGke5JL.js";class x extends T{render(){const e=this.getAttribute("edit-value"),o=this.getAttribute("columns"),l=this.getAttribute("title")||"",i=this.getAttribute("type")||"Visual";let t=[],a=[];try{e&&(t=JSON.parse(e)),o&&(a=JSON.parse(o))}catch(n){console.warn("Error parseando tabla",n)}const r=a.filter(n=>!n.hidePrint),s=i==="Compacto",u=i==="Facil Lectura",b=s?"0.75rem":u?"1.2rem":"0.95rem",f=s?"0.65rem":u?"1rem":"0.75rem",m=`width: 100%; border-collapse: collapse; font-size: ${b}; page-break-inside: auto;`,d=s?"2px 4px":u?"8px":"6px 8px",g=`
      <table style="${m}">
