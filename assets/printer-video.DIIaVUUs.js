import{B as l}from"./BaseElement.9fGzvbuo.js";import"./Elements.B8W_hxTW.js";import"./FormulaEngine.CYGke5JL.js";class c extends l{render(){let e={url:"",title:"",caption:""};try{const n=this.getAttribute("edit-value");n&&(e=JSON.parse(n))}catch{e.url=this.getAttribute("edit-value")||""}if(!e.url){this.innerHTML="",queueMicrotask(()=>this.dispatchEvent(new CustomEvent("dg-media-ready",{bubbles:!0})));return}const i=e.url.startsWith("github://"),s=i?`
