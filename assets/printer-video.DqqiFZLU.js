import{B as l}from"./BaseElement.pPTaffjx.js";import"./preload-helper.BUfFKGiv.js";import"./FormulaEngine.DHpTffcI.js";class c extends l{render(){let e={url:"",title:"",caption:""};try{const n=this.getAttribute("edit-value");n&&(e=JSON.parse(n))}catch{e.url=this.getAttribute("edit-value")||""}if(!e.url){this.innerHTML="",queueMicrotask(()=>this.dispatchEvent(new CustomEvent("dg-media-ready",{bubbles:!0})));return}const i=e.url.startsWith("github://"),s=i?`
    ...
    `,i){queueMicrotask(()=>this.dispatchEvent(new CustomEvent("dg-media-ready",{bubbles:!0})));return}const a=`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${encodeURIComponent(e.url)}`,r=this.querySelector(`#qr-container-${this.id}`),t=new Image;t.alt="Código QR",t.style.cssText="width: 100%; height: 100%; object-fit: contain; padding: 2px;";const o=()=>{r&&(r.innerHTML="",r.appendChild(t)),this.dispatchEvent(new CustomEvent("dg-media-ready",{bubbles:!0}))};t.onload=o,t.onerror=o,t.src=a}}customElements.define("printer-video",c);export{c as PrinterVideo};
