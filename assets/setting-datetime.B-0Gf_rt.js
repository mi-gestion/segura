import{B as n}from"./BaseElement.D4tveIlI.js";import{T as a,e as r}from"./Elements.BsmmG6jM.js";import"./FormulaEngine.CYGke5JL.js";class o extends n{static get observedAttributes(){return[...super.observedAttributes,"time-type"]}setData(t){super.setData(t);let e="date";t.tag===a.time&&(e="time"),this.setAttribute("time-type",e)}getData(){const t=super.getData();return(this.getAttribute("time-type")||"date")==="time"?t.tag=a.time:t.tag=a.date,t}render(){const t=this.getAttribute("title")||"",e=t.trim()===""?"is-invalid":"",l=this.getAttribute("time-type")||"date",s=r[l]||r.datetime;this.innerHTML=`
