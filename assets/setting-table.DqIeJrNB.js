import{B as x}from"./BaseElement.B8W23fke.js";import{e as h}from"./Elements.BsmmG6jM.js";import{f as w,b as $,D as C}from"./main.DUP_xBVN.js";import{D as k}from"./FormulaEngine.CYGke5JL.js";import"./preload-helper.B26yNZZz.js";const A=["dark","secondary","primary","success","danger","warning","info"];function y(t){return A.includes(t)?"text-white":"text-dark"}const E={show(t,e={}){const a=e.excludedTypes||[],s=e.modalTitle||"Configurar Columnas",l=e.modalIcon||"fa-table-columns",c=`modal-tbl-${t.id}`,p=document.getElementById(c);p&&p.remove();const o=`
