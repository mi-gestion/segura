import{B as r}from"./BaseElement.d_VolxdG.js";import"./Elements.B8W_hxTW.js";import"./FormulaEngine.CYGke5JL.js";class a extends r{render(){let t={url:"",title:"",caption:""};try{const e=this.getAttribute("edit-value");e&&(t=JSON.parse(e))}catch{t.url=this.getAttribute("edit-value")||""}const n=this.getAttribute("span-edit-viewer")||this.spanEV||"12";if(!t.url){this.innerHTML="";return}this.className=`col-md-${n} mb-3 d-block`;const s=t.url.startsWith("github://");this.innerHTML=`
