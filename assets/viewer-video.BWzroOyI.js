import{B as b}from"./BaseElement.d_VolxdG.js";import"./Elements.B8W_hxTW.js";import"./FormulaEngine.CYGke5JL.js";class v extends b{static get observedAttributes(){return[...super.observedAttributes,"controls","autoplay"]}render(){let e={url:"",title:"",caption:""};try{const t=this.getAttribute("edit-value");t&&(e=JSON.parse(t))}catch{e.url=this.getAttribute("edit-value")||""}const p=this.getAttribute("span-edit-viewer")||this.spanEV||"12";if(!e.url){this.innerHTML="";return}this.className=`col-md-${p} mb-3 d-block`;const i=e.url.startsWith("github://"),o=this.getAttribute("controls"),h=o===null?!0:o==="true",n=this.hasAttribute("autoplay"),l=h?" controls":"",r=n?" autoplay muted playsinline":"",a=i?null:this._checkVideo(e.url),d=a&&a.type==="youtube",m=d?`https://www.youtube.com/embed/${a.id}?rel=0${n?"&autoplay=1&mute=1":""}`:"";this.innerHTML=`
